...
var toatt_sunchun = require('./routes/att_sunchun');
var toatt_pohang = require('./routes/att_pohang');
var toatt_jeonju = require('./routes/att_jeonju');
var toatt_gangneung = require('./routes/att_gangneung');
...
app.use('/att_sunchun',toatt_sunchun);
app.use('/att_jeonju',toatt_jeonju);
app.use('/att_pohang',toatt_pohang);
app.use('/att_gangneung',toatt_gangneung);
