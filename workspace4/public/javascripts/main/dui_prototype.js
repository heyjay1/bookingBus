...
/**
 * DevOn UI Javascript framework, dui_prototype.js version 1.1
 *
 * prototype.js의 내용중 jquery등과의 충돌문제로  인해 아래부분을 일부 수정하였고
 * 파일 하단에 필요한 기능을 몇 개 추가하였음
 *
 * 원본에서 수정된 부분 : $() -> D$(), $$() -> D$$()
 *
 * AUTHORS LIST       E-MAIL
...
dui.CB.getWindowRect = function (win) {
	win = win || window;
	doc = win.document;
	var rect = new Object();
	var width, height;
